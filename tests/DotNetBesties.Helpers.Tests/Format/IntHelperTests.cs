...
public class IntHelperTests
{
    ...
    public async Task Days_FromTimeSpan_ReturnsExpected()
    {
        ...
        await Assert.That(IntHelper.Days(ts)).IsEqualTo(5);
    }
    ...
    public async Task Seconds_FromTimeSpan_ReturnsExpected()
    {
        ...
        await Assert.That(IntHelper.Seconds(ts)).IsEqualTo(ts.Seconds);
    }
    ...
    public async Task IsoWeek_ShouldReturnExpectedWeek()
    {
        ...
        await Assert.That(IntHelper.IsoWeek(date)).IsEqualTo(1);
    }
    ...
    public async Task IsIsoWeek_ShouldMatchIsoWeekOfYear()
    {
        ...
        await Assert.That(IntHelper.IsoWeek(date)).IsEqualTo(expected);
    }
}
